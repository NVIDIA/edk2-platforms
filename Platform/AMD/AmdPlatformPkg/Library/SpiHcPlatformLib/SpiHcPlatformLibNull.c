/** @file
  Combined NULL instance of SpiHcPlatformLib for DXE_DRIVER and DXE_SMM_DRIVER.
...
/**
  ...
  @retval EFI_UNSUPPORTED         Platform does not provide SPI HC details.
...
/**
  ...
  @retval EFI_UNSUPPORTED         Platform does not provide an SPI HC device path.
...
/**
  ...
  @retval EFI_UNSUPPORTED         Platform does not implement chip select.
...
/**
  ...
  @retval EFI_UNSUPPORTED         Platform does not implement SPI clock setup.
...
/**
  ...
  @retval EFI_UNSUPPORTED         Platform does not implement SPI transactions.
