...
#ifndef ESPI_NOR_FLASH_H_
#define ESPI_NOR_FLASH_H_
...
UINT32
FillWriteBuffer (
  IN      ESPI_NOR_FLASH_INSTANCE  *SpiNorFlashInstance,
  IN      UINT8                    Opcode,
...
/**
  Set the flash size based on the chip connected.

  This routine reads parameters from the SPI chip to determine the SPI flash
  size.

  @param[in]  SpiNorInstance    Spi Nor Flash Instance data with pointer to
...
EFIAPI
InstallFlashSize (
  IN  ESPI_NOR_FLASH_INSTANCE  *SpiNorInstance
  );
