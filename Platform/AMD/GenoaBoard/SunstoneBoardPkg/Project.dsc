...
!ifndef PLATFORM_CRB
  PLATFORM_CRB                   = Sunstone
!endif
  PLATFORM_NAME                  = $(PLATFORM_CRB)BoardPkg
  PLATFORM_GUID                  = 12DE9B28-76BE-454C-A337-297ECCB359B7
...
!endif
  ...
  DEFINE PLATFORM_CRB_TABLE_ID = "SUNSTONE"
...
[PcdsFixedAtBuild]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdAcpiDefaultOemTableId|0x454E4F54534E5553  # "SUNSTONE"
  gMinPlatformPkgTokenSpaceGuid.PcdMaxCpuCoreCount|96
  ...
  gUefiCpuPkgTokenSpaceGuid.PcdCpuMaxLogicalProcessorNumber|192
