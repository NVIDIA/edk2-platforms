...
!ifndef PLATFORM_CRB
  PLATFORM_CRB                   = Titanite
!endif
  PLATFORM_NAME                  = $(PLATFORM_CRB)BoardPkg
  PLATFORM_GUID                  = 7742fee3-af4d-4e51-8cce-993ca910de54
...
!endif
  ...
  DEFINE PLATFORM_CRB_TABLE_ID = "TITANITE"
  ...
  DEFINE PREDEFINED_FABRIC_RESOURCES = FALSE
  ...
  #
  # Background info:
  #   As per PPR vol7 17.4.10 UART Registers
  #   There are 4 physical UARTS available for SBIOS.
...
# Board specific PCDs
[PcdsFixedAtBuild]
  gEfiAmdAgesaPkgTokenSpaceGuid.PcdAmdSmbiosSocketDesignationSocket0|"A0"
  gEfiAmdAgesaPkgTokenSpaceGuid.PcdAmdSmbiosSocketDesignationSocket1|"A1"
  gEfiMdeModulePkgTokenSpaceGuid.PcdAcpiDefaultOemTableId|0x4554494E41544954  # "TITANITE"
  gMinPlatformPkgTokenSpaceGuid.PcdMaxCpuCoreCount|256
  ...
  gEfiAmdAgesaModulePkgTokenSpaceGuid.PcdAmdMemMaxDimmPerChannelV2|2
  gEfiAmdAgesaModulePkgTokenSpaceGuid.PcdAmdMemMaxSocketSupportedV2|2
