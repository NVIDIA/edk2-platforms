...
!ifndef PLATFORM_CRB
  # emulation is based on Chalupa including all PCDs and reference settings
  PLATFORM_CRB                   = Chalupa
!endif
  PLATFORM_NAME                  = EmulationBoardPkg
  PLATFORM_GUID                  = C305E1F5-98FA-447D-846F-0863BBE8796A
...
!endif
  ...
  DEFINE PLATFORM_CRB_TABLE_ID = "EMULATE "
  ...
  # DRAM boot for emulation, set this flag to TRUE for pure Emulation environment
  DEFINE DRAM_BOOT = TRUE
...
[PcdsFixedAtBuild]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdAcpiDefaultOemTableId|0x204151554C414843 # "CHALUPA "
...
[PcdsDynamicDefault]
  ...
  gEfiAmdAgesaPkgTokenSpaceGuid.PcdAmdTransparentErrorLoggingEnable|TRUE
  !if $(USB_SUPPORT)
    ### USB 3.0 controller0
