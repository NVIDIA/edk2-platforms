...
*/
#define GICC_ENTRY(CPUInterfaceNumber, \
                   Mpidr,              \
                   PmuIrq,             \
                   VGicIrq,            \
                   GicRedistBase,      \
                   ...
                   ClockDomain         \
                        ...
                        FixedPcdGet64 (PcdGicInterruptInterfaceBase), /* UINT64  PhysicalBaseAddress          */ \
                        0,                                            /* UINT64  GICV                         */ \
                        0,                                            /* UINT64  GICH                         */ \
...
*/
#define PROC_NODE_FLAGS(PhysicalPackage,                \
...
*/
#define CACHE_ATTRIBUTES(AllocationType,     \
                         CacheType,          \
                         WritePolicy         \
                         )                   \
                         (AllocationType |   \
