/** @file
  SMBIOS Type 32 (System Boot Information) table for ARM Morello System
...
} ARM_MORELLO_SMBIOS_TYPE32;
#pragma pack()

/* System Boot Information */
STATIC ARM_MORELLO_SMBIOS_TYPE32  mArmMorelloSmbiosType32 = {
  {
    {
      // SMBIOS header
...
/**
  ...
  Install the SMBIOS system boot information (type 32) table for ARM Morello
  ...
  )
{
  ...
  SmbiosHandle = ((EFI_SMBIOS_TABLE_HEADER *)&mArmMorelloSmbiosType32)->Handle;
  ...
  Status = Smbios->Add (
                     ...
                     NULL,
                     &SmbiosHandle,
                     (EFI_SMBIOS_TABLE_HEADER *)&mArmMorelloSmbiosType32
                     );
  if (EFI_ERROR (Status)) {
    DEBUG ((
      DEBUG_ERROR,
