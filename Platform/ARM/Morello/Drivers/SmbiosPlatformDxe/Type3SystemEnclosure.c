/** @file
  SMBIOS Type 3 (System enclosure) table for ARM Morello System
  Development Platform.

  This file installs SMBIOS Type 3 (System enclosure) table for ARM Morello
  System Development Platform. SMBIOS Type 3 table (System Enclosure) includes
  information about manufacturer, type, serial number and other information
  related to  system enclosure.
...
} ARM_MORELLO_SMBIOS_TYPE3;
#pragma pack()

/* System information */
STATIC ARM_MORELLO_SMBIOS_TYPE3  mArmMorelloSmbiosType3 = {
  {
    {
      // SMBIOS header
    ...
    MiscChassisTypeTower,           // Enclosure type is Tower
    Version,                        // Version
    SerialNumber,                   // Serial
    AssetTag,                       // Asset Tag
    ...
    ChassisSecurityStatusNone,      // Security Status
  ...
  )
{
  ...
  SmbiosHandle = ((EFI_SMBIOS_TABLE_HEADER *)&mArmMorelloSmbiosType3)->Handle;
  ...
  Status = Smbios->Add (
                     ...
                     NULL,
                     &SmbiosHandle,
                     (EFI_SMBIOS_TABLE_HEADER *)&mArmMorelloSmbiosType3
                     );
  if (EFI_ERROR (Status)) {
    DEBUG ((
      DEBUG_ERROR,
