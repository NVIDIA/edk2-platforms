...
GCC:   *_*_IA32_CC_FLAGS      = $(DSC_PLTPKG_FEATURE_BUILD_OPTIONS) -DASF_PEI -Wno-unused -Wl,--allow-multiple-definition
...
GCC:   *_*_X64_CC_FLAGS       = $(DSC_PLTPKG_FEATURE_BUILD_OPTIONS) -Wno-unused -Wl,--allow-multiple-definition
