...
#define PCD_TO_FV_HEADER_FILE_SYSTEM_GUID(Pcd)  (&((EFI_FIRMWARE_VOLUME_HEADER *)(EFI_PHYSICAL_ADDRESS)PcdGet32 (Pcd))->FileSystemGuid)
  ...
  )
{
  ...
  EFI_PEI_FIRMWARE_VOLUME_INFO2_PPI  *Ppi;
  EFI_STATUS                         Status;
