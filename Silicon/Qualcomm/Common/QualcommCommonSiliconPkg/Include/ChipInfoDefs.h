...
/**
  ...
  Used when comparing against the return value of
  ChipInfoGetChipVersion().  For example to check if this is at least
  version 1.2:
    Version = ChipInfoGetChipVersion ();
...
/**
  Maximum length of a chip id string, including the NULL terminator.

  Use when declaring space for ChipInfoGetChipIdString.
**/
#define CHIPINFO_MAX_ID_LENGTH  32

/**
  Maximum length of a processor name string, including the NULL
  terminator.

  Use when declaring space for ChipInfoGetMarketingNameString.
**/
...
#define CHIPINFO_QFPROM_CHIP_ID_UNKNOWN     0x0
...
/**
  ...
  For example:
    1.0 -> 0x00010000
    2.3 -> 0x00020003
  Use the CHIPINFO_VERSION macro to generate the appropriate comparison
  value, as the format is not guaranteed to remain unchanged.
**/
...
typedef enum {
  ...
  CHIPINFO_FAMILY_32BITS = 0x7FFFFFFF
} ChipInfoFamilyType;
...
**/
typedef enum {
  CHIPINFO_FOUNDRY_ID_UNKNOWN    = 0,
  CHIPINFO_FOUNDRY_ID_TSMC       = 1,
  CHIPINFO_FOUNDRY_ID_GF         = 2,
  CHIPINFO_FOUNDRY_ID_SS         = 3,
  CHIPINFO_FOUNDRY_ID_IBM        = 4,
  CHIPINFO_FOUNDRY_ID_UMC        = 5,
  CHIPINFO_FOUNDRY_ID_SMIC       = 6,
  CHIPINFO_FOUNDRY_ID_SAMSUNG_S5 = 7,

  CHIPINFO_NUM_FOUNDRY_IDS,
  CHIPINFO_FOUNDRY_ID_32BITS = 0x7FFFFFFF
...
**/
typedef struct {
  ChipInfoFeatureCodeType    FeatureCode;
  ChipInfoPCodeType          PCode;
} ChipInfoSkuType;
